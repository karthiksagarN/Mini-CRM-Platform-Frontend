...
import { ArrowLeft, Save, Megaphone, Target, MessageSquare, Sparkles, Send } from 'lucide-react';
...
export default function CreateCampaign() {
  ...
  const handleSubmit = async (e: React.FormEvent, autoSend = false) => {
    ...
    try {
      ...
      if (autoSend) {
        // Trigger send right after creation
        await api.post(`/campaigns/${campaignId}/send`);
        toast({
          title: "Campaign sent",
          description: `${formData.name} campaign has been sent to its customers.`,
        });
      }
        ...
        <form onSubmit={(e) => handleSubmit(e)} className="space-y-6">
          ...
          <div className="glass-card p-6 space-y-4">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="text-lg font-semibold text-foreground">Campaign Message</h3>
            </div>
