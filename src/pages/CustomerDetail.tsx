...
import { ArrowLeft, Mail, Calendar, DollarSign, ShoppingBag, User } from 'lucide-react';
    ...
    <div className="p-8 space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="glass-card p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-foreground mt-1">{customer.name || 'Not provided'}</p>
              </div>
              <div>
          ...
          {/* Custom Attributes */}
          {customer.attributes && Object.keys(customer.attributes).length > 1 && (
            <div className="glass-card p-6">
        ...
        <div className="space-y-6">
          <div className="glass-card p-6">
            ...
            <div className="space-y-3">
              <Button
                ...
                size="sm"
                icon={ShoppingBag}
                onClick={() => navigate(`/orders/new?customerId=${customer._id}`)}
              ...
              <Button
                variant="outline"
                size="sm"
                onClick={() => navigate(`/campaigns/new?customerId=${customer._id}`)}
                className="w-full justify-start"
              >
                Create Campaign
              </Button>
          ...
          <div className="glass-card p-6 text-center">
            ...
            <h4 className="font-semibold text-foreground">{customer.name || 'Customer'}</h4>
